...
<html lang="en">
  ...
  <head>
    ...
    <link rel="preload" href="<c:url value='/template/css/adminlte.css'/>" as="style" />
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="<c:url value='/template/assets/img/user8-128x128.jpg'/>"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="<c:url value='/template/assets/img/user3-128x128.jpg'/>"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="<c:url value='/approval'/>" class="nav-link">
